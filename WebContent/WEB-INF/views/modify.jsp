		...
		<div class="container-login100"
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form">
					<span class="login100-form-title p-b-24"> <img
						src="https://media3.giphy.com/media/FV2QgOaUEXtyE/giphy.gif?cid=ecf05e47e00733d6d01f1003a835047197c3737395677510&rid=giphy.gif"
					...
					<div class="wrap-input100 validate-input m-b-23"
						...
						<span class="label-input100">User ID</span> <input
							...
							placeholder="아이디를 입력하세요"value="${user.ui_id}"> <span class="focus-input100"
							data-symbol="&#xf206;"></span>
					</div>
					...
					<div class="wrap-input100 validate-input"
						...
						<span class="label-input100">Password</span> <input
							...
							id="ui_password" placeholder="비밀번호를 입력하세요" value="${user.ui_password}"> <span
					...
					<div class="wrap-input100 validate-input m-b-23"
						...
						<span class="label-input100">User Name</span> <input
							...
							placeholder="성명을 입력하세요" value="${user.ui_name}"> <span class="focus-input100"
							data-symbol="&#xf206;"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-23"
						data-validate="ID is reauired">
					...
					<div class="wrap-input100 validate-input m-b-23"
						...
						<span class="label-input100">User Email</span> <input
							...
							placeholder="이메일을 입력하세요"value="${user.ui_email}"> <span class="focus-input100"
							data-symbol="&#xf206;"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-23"
						data-validate="ID is reauired">
						<span class="label-input100">User Phone</span> <input
							...
							placeholder="휴대전화를 입력하세요"value="${user.ui_phone}"> <span class="focus-input100"
							data-symbol="&#xf206;"></span>
					</div>
					<div class="wrap-input100 validate-input m-b-23"
						data-validate="ID is reauired">
						<span class="label-input100">User Nickname</span> <input
							...
							placeholder="닉네임을 입력하세요" value="${user.ui_nickname}"> <span class="focus-input100"
							data-symbol="&#xf206;"></span>
					</div>
